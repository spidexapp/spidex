 ...
 *
 * This contracts uses {AccessControl} to lock permissioned functions using the
 * different roles - head to its documentation for details.
 *
 * The account that deploys the contracts will be granted the minter and pauser
...
contract ERC20MinterBurnerDecimals is Context, AccessControlEnumerable, ERC20Burnable, ERC20Pausable {
  ...
  /**
    ...
    * account that deploys the contracts and customizes tokens decimals
    *

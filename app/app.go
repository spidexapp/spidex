...
import (
	...
	"github.com/spidexapp/spidex/app/ante"
	v2 "github.com/spidexapp/spidex/app/upgrades/v2"
	v3 "github.com/spidexapp/spidex/app/upgrades/v3"

	simappparams "github.com/cosmos/cosmos-sdk/simapp/params"

	oraclemodule "github.com/spidexapp/spidex/x/oracle"
	oraclemodulekeeper "github.com/spidexapp/spidex/x/oracle/keeper"
	oraclemoduletypes "github.com/spidexapp/spidex/x/oracle/types"

	"github.com/spidexapp/spidex/x/erc20"
	erc20client "github.com/spidexapp/spidex/x/erc20/client"
	erc20keeper "github.com/spidexapp/spidex/x/erc20/keeper"
	erc20types "github.com/spidexapp/spidex/x/erc20/types"
...
func init() {
	...
	// manually update the power reduction by replacing micro (u) -> atto (a) Spidex
...
func New(
	...
	keys := sdk.NewKVStoreKeys(
		...
		oraclemoduletypes.StoreKey, erc20types.StoreKey,
	...
	app.AccountKeeper.GetModuleAddress("")
	...
	*/
	...
	ibcKeep := ibctransferkeeper.NewKeeper(
		appCodec, keys[ibctransfertypes.StoreKey], app.GetSubspace(ibctransfertypes.ModuleName),
		app.IBCKeeper.ChannelKeeper, app.IBCKeeper.ChannelKeeper, &app.IBCKeeper.PortKeeper,
		app.AccountKeeper, app.BankKeeper, scopedTransferKeeper,
	)
	app.TransferKeeper = &ibcKeep
	...
	app.TransferKeeper = app.TransferKeeper.SetHooks(
		ibctransferkeeper.NewMultiIbcTransferHooks(
			app.Erc20Keeper.Hooks(),
		))

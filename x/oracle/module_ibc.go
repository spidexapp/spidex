...
func (am AppModule) OnChanOpenTry(
	...
	if !am.keeper.ScopedKeeper.AuthenticateCapability(ctx, chanCap, host.ChannelCapabilityPath(portID, channelID)) {
...
func (am AppModule) OnRecvPacket(
	...
	default:
		errMsg := fmt.Errorf("unrecognized %s packet type: %T", types.ModuleName, packet)
...
func (am AppModule) OnAcknowledgementPacket(
	...
	if err := modulePacketData.Unmarshal(modulePacket.GetData()); err != nil {
		fmt.Println("111222")
		fmt.Println(modulePacket.GetData())
		fmt.Println(string(modulePacket.GetData()))
